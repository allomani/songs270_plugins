...
s1.write('preview'); 
    ...
    ?>
        ...
        <?
          print "<PARAM NAME=\"SRC\" VALUE=\"{$data_url['url']}\" ref>    \n";
          ?>
          ...
          <embed  src="<? print "{$data_url['url']}";?>" align="baseline" border="0" width="350" height="60" type="audio/x-pn-realaudio-plugin" console="One" controls="ControlPanel,statusbar" autostart="true"> </embed>
        </OBJECT>
        <br> 
