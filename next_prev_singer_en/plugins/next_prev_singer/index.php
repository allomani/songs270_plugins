...
print "Prev. Singer : <a href='singer-".$list[$prev_index]['id'].".html'>".$list[$prev_index]['name']."</a>";
}
print "</td><td width=50% align=left>";
 if($list[$next_index]['name']){
print "Next Singer : <a href='singer-".$list[$next_index]['id'].".html'>".$list[$next_index]['name']."</a>";
}
print "</td></tr></table>";
close_table();
}
