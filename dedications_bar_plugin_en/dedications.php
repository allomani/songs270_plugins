<?
include "global.php" ;
print "<html dir=rtl><body topmargin=\"0\" leftmargin=\"0\">
<LINK href=\"css.php\" type=\"text/css\" rel=\"stylesheet\">    \n";

print "<table width=100% style=\"padding: 0\"><tr><td>";
...
print "</marquee>";
        ...
        print "<center>  No Dedications </center>";
        }
print "</td><td width=10%>
<a href='#' onclick=\"window.open('send_dedication.php','displaywindow','toolbar=no,scrollbars=no,width=350,height=380,top=200,left=200');return false;\"> Send </a>
<br>
